...
public class SwitchNoBreakExam {
	...
	public static void main(String[] args) {
		// switch문은 의도에 따라 break를 생략할 수 있다.'
		// 시간에 따라서 스케쥴 제공 프로그램
		...
		case 14 :
			System.out.println("5교시 응용 실습을 진행 합니다. ");
					
		case 15 :
			System.out.println("6교시 응용 실습을 진행 합니다. ");
			
		case 16 :
			System.out.println("7교시 오후 수업을 진행합니다. ");
		...
		default : 
			System.out.println((time) + "시 현재 일과시간이 아닙니다. 휴식 하세요");
