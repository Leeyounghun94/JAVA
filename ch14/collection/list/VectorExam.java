...
public class VectorExam {
	...
	public static void main(String[] args) {
		...
		// 단, 동기화된 메서드로 구성되어 있어 멀티스레드가 동시에 이 메서드를 실행할 수 없고
		// 하나의 스레드가 실행완료 해야 다른 스레드를 실행할 수 있다.
		...
		listB.add(new BoardDTO("제목1", "내용1", "작성자1"));	//0번
		listB.add(new BoardDTO("제목2", "내용2", "작성자2"));	//1번
		...
		System.out.print(">>>");
		newBoardDTO.setSubject(scanner.next());	//세터로 입력 할려면 이렇게 만들어야한다. 1. 객체 먼저 만들고 2. exam에다가 기본생성자 만들고 .set 해주면 됨.
		...
		System.out.println(newBoardDTO.toString());	// toString = 테스트용(모든 주소가 다 나옴)
